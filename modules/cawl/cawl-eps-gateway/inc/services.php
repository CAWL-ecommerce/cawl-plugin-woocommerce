...
use Cawl\Vendor\Worldline\WorldlineForWoocommerce\EpsGateway\Payment\EpsRequestModifier;
...
return static function () : array {
    ...
    return ["payment_gateway.{$gatewayId}.form_fields" => Service::fromFile("{$moduleRoot}/inc/fields.php"), "payment_gateway.{$gatewayId}.method_title" => static fn(): string => \__('EPS (CAWL)', 'cawl-for-woocommerce'), "payment_gateway.{$gatewayId}.title" => new Factory([], static function () use($gatewayId) : string {
