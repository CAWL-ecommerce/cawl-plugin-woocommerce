...
//phpcs:disable CAWL.CodeQuality.NestingLevel.High
...
use Cawl\Vendor\Worldline\PaymentGateway\Fields\ContentField;
    ...
    public function services() : array
    {
        return \array_merge([
            ...
            'payment_gateways.i18n.messages' => static fn(): array => ['refund_order_not_found' => static fn(array $params): string => \sprintf(
                ...
                \__('Failed to process the refund: the order with ID %1$s not found', 'worldline-payment-gateway'),
                (string) $params['orderId']
            ), 'refund_failed' => \__('Failed to refund the order payment', 'worldline-payment-gateway'), 'payment_method_not_available' => \__('Payment method not available. Please select another payment method.', 'worldline-payment-gateway')],
