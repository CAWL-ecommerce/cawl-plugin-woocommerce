...
use Syde\Vendor\Cawl\Dhii\Services\Factories\FuncService;
...
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\KlarnaGateway\Payment\BankTransferRequestModifier;
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\KlarnaGateway\Payment\DirectDebitRequestModifier;
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\KlarnaGateway\Payment\FinancingRequestModifier;
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\KlarnaGateway\Payment\PayLaterRequestModifier;
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\KlarnaGateway\Payment\PayNowRequestModifier;
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\KlarnaGateway\Payment\PayWithKlarnaRequestModifier;
...
return static function () : array {
    ...
    $getGatewayFormFields = static function (string $gatewayLabel, string $titlePlaceholder) : array {
        return ['enabled' => [
            'title' => \__('Enable/Disable', 'cawl-for-woocommerce'),
            'type' => 'checkbox',
            /* translators: %s: Name of the gateway. */
            'label' => \sprintf(\__('Enable %s', 'cawl-for-woocommerce'), $gatewayLabel),
            'default' => 'no',
        ], 'title' => ['title' => \__('Title', 'cawl-for-woocommerce'), 'type' => 'text', 'description' => \__('Personalize the payment method title on the checkout page.', 'cawl-for-woocommerce'), 'desc_tip' => \__('If left empty, the default payment method name will be displayed on the checkout page.', 'cawl-for-woocommerce'), 'placeholder' => $titlePlaceholder]];
    };
    ...
    $payWithKlarnaServices = ["payment_gateway.{$gatewayIdPayWithKlarna}.form_fields" => static fn(): array => $getGatewayFormFields(\__('Pay with Klarna (CAWL)', 'cawl-for-woocommerce'), \__('Pay with Klarna', 'cawl-for-woocommerce')), "payment_gateway.{$gatewayIdPayWithKlarna}.method_title" => static fn(): string => \__('Pay with Klarna (CAWL)', 'cawl-for-woocommerce'), "payment_gateway.{$gatewayIdPayWithKlarna}.title" => new Factory([], static function () use($gatewayIdPayWithKlarna) : string {
