...
namespace Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\WeroGateway\Admin;
...
class WeroRefundReasonUi
{
    ...
    public function renderRefundReasonScript() : void
    {
        ...
        $label = \esc_html__('Reason for refund (Wero):', 'cawl-for-woocommerce');
        $tooltip = \esc_attr__('Required refund reason sent to Wero', 'cawl-for-woocommerce');
        ?>
