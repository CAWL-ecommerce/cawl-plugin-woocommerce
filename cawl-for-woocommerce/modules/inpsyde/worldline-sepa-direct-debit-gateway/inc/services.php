...
use Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\SepaDirectDebitGateway\Payment\SepaDirectDebitRequestModifier;
...
return static function () : array {
    ...
    return [
        ...
        // Titles & descriptions
        "payment_gateway.{$gatewayId}.method_title" => static fn(): string => \__('SEPA Direct Debit (CAWL)', 'cawl-for-woocommerce'),
        "payment_gateway.{$gatewayId}.title" => static fn(): string => \__('SEPA Direct Debit', 'cawl-for-woocommerce'),
        "payment_gateway.{$gatewayId}.method_description" => static fn(): string => \__('Pay via SEPA Direct Debit. Customer will be redirected to complete the SEPA mandate flow.', 'cawl-for-woocommerce'),
