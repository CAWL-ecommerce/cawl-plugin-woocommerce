...
namespace Cawl\Vendor\enshrined\svgSanitize\ElementReference;

use Cawl\Vendor\enshrined\svgSanitize\data\XPath;
use Cawl\Vendor\enshrined\svgSanitize\Exceptions\NestingException;
use Cawl\Vendor\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath
