...
namespace Cawl\Vendor\Worldline\Wp\HttpClient;

use Cawl\Vendor\Worldline\Wp\HttpClient\Exception\NetworkException;
use Cawl\Vendor\Worldline\Wp\HttpClient\Exception\RequestException;
use Cawl\Vendor\Psr\Http\Client\ClientInterface;
use Cawl\Vendor\Psr\Http\Message\RequestInterface;
use Cawl\Vendor\Psr\Http\Message\ResponseFactoryInterface;
use Cawl\Vendor\Psr\Http\Message\ResponseInterface;
use Cawl\Vendor\Psr\Http\Message\RequestFactoryInterface;
use Cawl\Vendor\Psr\Http\Message\StreamFactoryInterface;
use Cawl\Vendor\Psr\Http\Message\StreamInterface;
use WP_Http;
use WP_Http_Cookie;
