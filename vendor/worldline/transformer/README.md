...
```composer require worldline/transformer```

## Usage

*Worldline Transformer* works by supplying it with transformer functions which are inspected using the Reflection API.
...
```
Let's say you need to represent this payload as a `ProductInterface`. Here's how *Worldline Transformer* is going to help:
...
```php
use Worldline\Transformer\ConfigurableTransformer;
...
```php
use Worldline\Transformer\ConfigurableTransformer;use Worldline\Transformer\Exception\TransformerException;
...
```php
use Worldline\Transformer\Transformer;
use Worldline\Transformer\MutableTransformer;
use Worldline\Transformer\ReadOnlyTransformer;
...
```php
use Worldline\Transformer\ImmutableTransformer;
