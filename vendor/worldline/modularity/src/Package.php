...
namespace Cawl\Vendor\Worldline\Modularity;

use Cawl\Vendor\Worldline\Modularity\Container\ContainerConfigurator;
use Cawl\Vendor\Worldline\Modularity\Container\PackageProxyContainer;
use Cawl\Vendor\Worldline\Modularity\Module\ExtendingModule;
use Cawl\Vendor\Worldline\Modularity\Module\ExecutableModule;
use Cawl\Vendor\Worldline\Modularity\Module\FactoryModule;
...
/**
 * @psalm-import-type Service from \Worldline\Modularity\Module\ServiceModule
 * @psalm-import-type ExtendingService from \Worldline\Modularity\Module\ExtendingModule
 */
class Package
{
    /**
     ...
     * @return bool
     *
     * phpcs:disable Worldline.CodeQuality.FunctionLength
     */
    public function connect(Package $package) : bool
    {
        // phpcs:enable Worldline.CodeQuality.FunctionLength
        try {
            if ($package === $this) {
                return \false;
            }
