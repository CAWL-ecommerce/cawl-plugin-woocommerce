...
use Worldline\Assets\OutputFilter\AsyncStyleOutputFilter;
class Style extends \Worldline\Assets\BaseAsset implements \Worldline\Assets\Asset
{
    /**
     ...
     * @return static
     */
    public function forMedia(string $media) : \Worldline\Assets\Style
    {
        $this->media = $media;
        return $this;
    }
     ...
     */
    public function withInlineStyles(string $inline) : \Worldline\Assets\Style
    {
     ...
     * @example Style::withCssVars('.some-element', ['white' => '#fff']);
     */
    public function withCssVars(string $element, array $vars) : \Worldline\Assets\Style
    {
     ...
     * @return static
     */
    public function useAsyncFilter() : \Worldline\Assets\Style
    {
