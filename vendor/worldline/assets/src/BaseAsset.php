...
use Worldline\Assets\Util\AssetPathResolver;
use Worldline\Assets\OutputFilter\AssetOutputFilter;
use Worldline\Assets\OutputFilter\AttributesOutputFilter;
use Worldline\Assets\OutputFilter\InlineAssetOutputFilter;
/**
 * phpcs:disable Worldline.CodeQuality.PropertyPerClassLimit.TooManyProperties
 */
abstract class BaseAsset implements \Worldline\Assets\Asset
{
     ...
     * @param int $location
     */
    public function __construct(string $handle, string $url, int $location = \Worldline\Assets\Asset::FRONTEND | \Worldline\Assets\Asset::ACTIVATE)
    {
        $this->handle = $handle;
        $this->url = $url;
     ...
     * @return static
     */
    public function useInlineFilter() : \Worldline\Assets\Asset
    {
     ...
     * @return static
     */
    public function withData(array $data) : \Worldline\Assets\Asset
    {
