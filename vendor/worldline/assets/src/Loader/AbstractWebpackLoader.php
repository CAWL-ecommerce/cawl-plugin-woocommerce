...
use Worldline\Assets\Exception\InvalidResourceException;
use Worldline\Assets\Script;
use Worldline\Assets\Style;
abstract class AbstractWebpackLoader implements \Worldline\Assets\Loader\LoaderInterface
{
     ...
     * @return static
     */
    public function withDirectoryUrl(string $directoryUrl) : \Worldline\Assets\Loader\AbstractWebpackLoader
    {
