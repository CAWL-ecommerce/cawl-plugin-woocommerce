...
use Worldline\Assets\OutputFilter\AsyncScriptOutputFilter;
use Worldline\Assets\OutputFilter\AttributesOutputFilter;
use Worldline\Assets\OutputFilter\DeferScriptOutputFilter;
use Worldline\Assets\OutputFilter\InlineAssetOutputFilter;
use Worldline\Assets\Asset;
use Worldline\Assets\Script;
use WP_Scripts;
class ScriptHandler implements \Worldline\Assets\Handler\AssetHandler, \Worldline\Assets\Handler\OutputFilterAwareAssetHandler
{
    use \Worldline\Assets\Handler\OutputFilterAwareAssetHandlerTrait;
