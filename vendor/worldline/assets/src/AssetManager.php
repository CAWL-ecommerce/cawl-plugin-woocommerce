...
use Worldline\Assets\Handler\OutputFilterAwareAssetHandler;
use Worldline\Assets\Handler\ScriptHandler;
use Worldline\Assets\Handler\StyleHandler;
use Worldline\Assets\Util\AssetHookResolver;
final class AssetManager
{
     ...
     * @return static
     */
    public function useDefaultHandlers() : \Worldline\Assets\AssetManager
    {
     ...
     * @return static
     */
    public function withHandler(string $name, AssetHandler $handler) : \Worldline\Assets\AssetManager
    {
     ...
     * @return static
     */
    public function register(\Worldline\Assets\Asset $asset, \Worldline\Assets\Asset ...$assets) : \Worldline\Assets\AssetManager
    {
     ...
     * @return Asset|null
     */
    public function asset(string $handle, ?string $type = null) : ?\Worldline\Assets\Asset
    {
        $this->ensureSetup();
    ...
    private function loopCurrentHookAssets(string $currentHook, bool $process) : array
    {
        ...
        $locationId = \Worldline\Assets\Asset::HOOK_TO_LOCATION[$currentHook] ?? null;
        if (!$locationId) {
            return [];
        }
        $found = [];
